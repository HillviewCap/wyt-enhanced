-- Migration: Add Wigle API cache table
...
-- Schedule cleanup (this would typically be done with a cron job or scheduled task)
COMMENT ON FUNCTION cleanup_expired_wigle_cache() IS 'Function to clean up expired Wigle cache entries';

SELECT 'Wigle cache table created successfully' as result;